...
function display_image_immobile()
{
    ...
    if (!empty($gallery)) {
        ...
        if ($type == "application/pdf") {
            $content = '<img src="' . get_stylesheet_directory_uri() . '/assets/no-image.png" alt="No Image">';
        ...
        if (!empty($gallery)) {
            ...
            foreach ($gallery as $image) {
                ...
                if ($type == "application/pdf") { ?>
                    ...
                    addImageToCarousel("<?php echo get_stylesheet_directory_uri(); ?>/assets/no-image.png", swiperSelector);
                <?php
                } else { ?>
